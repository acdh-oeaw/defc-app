...
urlpatterns = [
    ...
    url(
        r"^area/create/$", views.create_area, name="area_create"
    ...
    url(
        r"^area/delete/(?P<pk>[0-9]+)$", views.AreaDelete.as_view(), name="area_delete"
    ),
    url(
    ...
    url(
        r"^researchevent/update/(?P<pk>[0-9]+)$",
