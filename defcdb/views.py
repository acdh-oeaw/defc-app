...
def update_researchevent(request, pk):
    ...
    if request.method == "POST":
        ...
        return render(
            request,
            "defcdb/update_form.html",
            {"form": form, "classname": "research event"},
        )
...
class FindsDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["researchevent_list"] = ResearchEvent.objects.filter(
            finds=current_find.id
        )
        current_find_2 = self.object
        context["interpretation_list"] = Interpretation.objects.filter(
            finds=current_find_2.id
        )
        ...
        context[
            "lithicsretouchedtools_list"
        ] = current_find.lithics_retouched_tools.all()
...
def update_site(request, pk):
    ...
    if request.method == "POST":
        ...
        return render(
            request, "defcdb/update_form.html", {"form": form, "classname": "site"}
        )
...
def update_area(request, pk):
    ...
    if request.method == "POST":
        ...
        return render(
            request, "defcdb/edit_area.html", {"form": form, "classname": "area"}
        )
...
class AreaDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["interpretations_list"] = Interpretation.objects.filter(
        ...
        context[
            "settlementconstructiontype_list"
        ] = current_area.settlement_construction_type.all()
        context[
            "settlementbuildingtechnique_list"
        ] = current_area.settlement_building_technique.all()
        context[
            "settlementspecialfeatures_list"
        ] = current_area.settlement_special_features.all()
        context[
            "evidenceofoccupation_list"
        ] = current_area.cave_rockshelters_evidence_of_occupation.all()
        ...
        context[
            "mortuaryfeatures_list"
        ] = current_area.cemetery_or_graves_mortuary_features.all()
        context["gravetype_list"] = current_area.grave_type.all()
        context[
            "typeofhumanremains_list"
        ] = current_area.grave_type_of_human_remains.all()
        context["graveagegroups_list"] = current_area.grave_age_groups.all()
        context["gravesexes_list"] = current_area.grave_sexes.all()
        context[
            "manipulationsofgraves_list"
        ] = current_area.grave_manipulations_of_graves.all()
        return context
...
def update_interpretation(request, pk):
    ...
    if request.method == "POST":
        ...
        return render(
            request,
            "defcdb/update_form.html",
            {"form": form, "classname": "interpretation"},
        )
