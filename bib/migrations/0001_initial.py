...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Book',
            fields=[
                ('zoterokey', models.CharField(serialize=False, max_length=100, primary_key=True)),
                ...
                ('publication_title', models.CharField(null=True, max_length=100, blank=True)),
                ('short_title', models.CharField(null=True, max_length=100, blank=True)),
                ('publication_year', models.CharField(null=True, max_length=100, blank=True)),
